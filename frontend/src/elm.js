...
var $author$project$Main$BouncingRunOut = function (a) {
	return {$: 'BouncingRunOut', a: a};
};
...
var $author$project$Main$iconClicked = _Platform_outgoingPort(
	'iconClicked',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$Main$flexColumn = A2(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$id('app')
			]),
		_List_fromArray(
			[
				A2(
				$author$project$Main$flexColumn,
				_List_fromArray(
					[
